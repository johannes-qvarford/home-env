...
choco install -y dropbox vscode keepass megasync firefox steam kodi teamviewer itch docker-desktop megatools vlc cpod bleachbit sqlitebrowser stretchly
